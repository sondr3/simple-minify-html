...
use memchr::memchr;
use minify_html_common::{gen::codepoints::Lookup, spec::tag::EMPTY_SLICE};

use crate::{
    err::{debug_repr, Error, ErrorType, ProcessingResult},
    proc::{range::ProcessorRange, MatchAction::*, MatchMode::*},
};
