use minify_html_common::{
    gen::{
        attrs::{AttributeMinification, ATTRS},
        codepoints::{TAG_NAME_CHAR, WHITESPACE},
    },
    spec::{
...
use crate::{
    cfg::Cfg,
    err::{ErrorType, ProcessingResult},
    proc::{
        checkpoint::{ReadCheckpoint, WriteCheckpoint},
        range::ProcessorRange,
        MatchAction::*,
        MatchMode::*,
        Processor,
    },
    unit::{
        attr::{process_attr, AttrType, ProcessedAttr},
