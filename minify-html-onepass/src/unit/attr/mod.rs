use minify_html_common::{
    gen::{
        attrs::ATTRS,
        codepoints::{WHATWG_ATTR_NAME_CHAR, WHITESPACE},
    },
...
use crate::{
    ...
    proc::{
        checkpoint::WriteCheckpoint, range::ProcessorRange, MatchAction::*, MatchMode::*, Processor,
    },
    unit::attr::value::{process_attr_value, skip_attr_value, DelimiterType, ProcessedAttrValue},
};
