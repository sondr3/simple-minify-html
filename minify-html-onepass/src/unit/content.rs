use minify_html_common::{
    gen::codepoints::{TAG_NAME_CHAR, WHITESPACE},
    spec::tag::{
        ns::Namespace,
...
use crate::{
    ...
    proc::{
        checkpoint::ReadCheckpoint, entity::maybe_normalise_entity, range::ProcessorRange,
        MatchAction::*, MatchMode::*, Processor,
    },
    unit::{
        bang::process_bang,
        comment::process_comment,
        instruction::process_instruction,
        tag::{process_tag, MaybeClosingTag},
    },
};
